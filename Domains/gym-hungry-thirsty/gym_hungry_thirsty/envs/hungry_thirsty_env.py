...
class HungryThirstyEnv(gym.Env):
    ...
    def __init__(self, size=(6, 6)):
        ...
        self.FOOD_IMG_IPY = ipywidgets.Image.from_file(home_dir + "/VisualAssets/PNG/soup_small.png")
        self.WATER_IMG_IPY = ipywidgets.Image.from_file(home_dir + "/VisualAssets/PNG/water_small.png")
        self.AGENT_IMG_IPY = ipywidgets.Image.from_file(home_dir + "/VisualAssets/PNG/cute_small.png")

        self.FOOD_IMG = Image.open(home_dir + "/VisualAssets/PNG/icons8-soup-plate-100.png")
        self.WATER_IMG = Image.open(home_dir + "/VisualAssets/PNG/icons8-water-100.png")
        self.AGENT_IMG = Image.open(home_dir + "/VisualAssets/PNG/icons8-cute-100.png")
