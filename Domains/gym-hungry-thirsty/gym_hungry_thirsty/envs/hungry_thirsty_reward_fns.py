...
def adversarial_reward_fn(state, action, new_state, a, b, c, d):
    """
...
def sparse_reward_fn(state, action, new_state, a, b, c, d):
    """
...
def nudge_reward_fn(state, action, new_state, a, b, c, d):
    """
...
def wdrcf_reward_fn(state, action, new_state, a, b, c, d):
    """
...
def tunable_reward_fn(state, action, new_state, a, b, c, d):
    ...
    """
    params = {
        "hungry_and_thirsty": a,
        "hungry_and_not_thirsty": b,
        "not_hungry_and_thirsty": c,
        "not_hungry_and_not_thirsty": d,
    }
    return general_reward_fn(params=params, state=state, action=action, new_state=new_state)
